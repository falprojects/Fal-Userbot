...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, fal_cmd


@fal_cmd(pattern="download(?: |$)(.*)")
...
@fal_cmd(pattern="uploadas(stream|vn|all) (.*)")
