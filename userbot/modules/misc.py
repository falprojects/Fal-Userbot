...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/falprojects/Fal-Userbot"
# ============================================
...
@fal_cmd(pattern="shutdown$")
async def killdabot(event):
    """ For .shutdown command, shut the bot down."""
    await edit_or_reply(event, "`Mematikan Fal-Userbot....`")
...
@fal_cmd(pattern="restart$")
async def killdabot(event):
    await edit_or_reply(event, "`Restarting Fal-Userbot...`")
...
@Fal_cmd(pattern="readme$")
async def reedme(e):
    await edit_or_reply(e,
                        "Here's Something for You to Read :\n"
                        "\n[⚡ Fal-Userbot Repo](https://github.com/falprojects/Fal-Userbot/blob/Fal-Userbot/README.md)"
                        "\n[Setup Guide - Basic](https://telegra.ph/How-to-host-a-Telegram-Userbot-11-02)"
                        "\n[Special - Note](https://telegra.ph/Special-Note-11-02)")


@fal_cmd(pattern="repeat (.*)")
...
@fal_cmd(pattern="repo$")
async def repo_is_here(wannasee):
    """ For .repo command, just returns the repo URL. """
    await edit_or_reply(wannasee,
                        "**Hey**, I am using **⚡𝐅𝐚𝐥-𝐔𝐬𝐞𝐫𝐛𝐨𝐭⚡** \n"
                        "卍━━━━━━━━━━━━━━━━━━━━━━卍\n"
...
@fal_cmd(pattern="string$")
async def repo_is_here(wannasee):
    """For .repo command, just returns the repo URL."""
    await edit_or_reply(wannasee,
                        f"➣ **GET STRING SESSION VIA BOT :** [KLIK DISINI](https://t.me/StringFal)\n"
                        )
...
CMD_HELP.update({
    ...
    \n↳ : `{cmd}sleep`\
    \n  •  **Function : Biarkan Fal-Userbot tidur selama beberapa detik.",
    "shutdown": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}shutdown`\
    \n↳ : Mematikan bot",
    "repo": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}repo`\
    \n↳ : Menampilan link Repository Fal-Userbot.",
    "string": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}string`\
    \n↳: Menampilkan link String Fal-Userbot",
